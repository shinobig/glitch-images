...
const randomGlitchZoomComponentTest = (props) => {
 // console.log(props)
  return (
    <div className="random-glitch" className="glitch-container" style={{ position: "fixed", top: `${props.positiony}vh`, left: `${props.positionx}vw`, width: `${props.maxWidth}vw`, height:`${props.maxHeight}vh` }}>
